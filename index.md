...
<img src="/assets/coto.jpg" alt="Rodrigo" width="120" height="120" style="float: left; margin-right: 15px;"/> Hey, I'm Rodrigo Cancino Augosto (also know as Coto). This is my personal site, it includes [Blog Posts of Free Topics][blog]{:target="_blank"} with undetermined update frequency. All the content is my own and has no relation to third parties.
